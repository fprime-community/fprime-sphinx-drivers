...
namespace Drv {
    ...
    precondition__RWReverse__SUCCESS8(void) const
  {
    ...
    //printf("Precondition for RWReverse SUCCESS8 result is: %d\n", result);
    return result;
  }


  void TestState ::
    action__RWReverse__SUCCESS8(void)
  {
    //printf("Action for RWReverse SUCCESS8\n");
  ...
  bool TestState ::
    precondition__RWReverse__SUCCESS16(void) const
  {
    bool result = true;
    result &= this->component.m_isOwned;
    //printf("Precondition for RWReverse SUCCESS16 result is: %d\n", result);
    return result;
  }


  void TestState ::
    action__RWReverse__SUCCESS16(void)
  {
  ...
  bool TestState ::
    precondition__RWReverse__SUCCESS32(void) const
  {
    bool result = true;
    result &= this->component.m_isOwned;
    //printf("Precondition for RWReverse SUCCESS32 result is: %d\n", result);
    return result;
  }


  void TestState ::
    action__RWReverse__SUCCESS32(void)
  {
