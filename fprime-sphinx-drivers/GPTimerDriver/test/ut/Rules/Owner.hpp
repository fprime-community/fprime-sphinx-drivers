// ====================================================================== 
// \title  Rules/Owner.hpp
// \author ciankc
// \brief  Rules/Owner class interface
//
// \copyright
...
#ifndef Drv_Owner_HPP
#define Drv_Owner_HPP
  ...
  namespace Owner {
    ...
    class Tester {
      ...
      public:
        ...
        void ClaimOK(void);
        void UnclaimOK(void);
        void ClaimERROR(void);
        void UnclaimERROR(void);
      ...
      public:
        ...
        Rules::Owner::ClaimOK ruleClaimOK;
        Rules::Owner::UnclaimOK ruleUnclaimOK;
        Rules::Owner::ClaimERROR ruleClaimERROR;
        Rules::Owner::UnclaimERROR ruleUnclaimERROR;
