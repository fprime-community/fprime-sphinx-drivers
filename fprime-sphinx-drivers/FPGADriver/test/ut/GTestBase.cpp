// ======================================================================
// \title  FPGADriver/test/ut/GTestBase.cpp
// \author Auto-generated
// \brief  cpp file for FPGADriver component Google Test harness base class
//
// \copyright
...
namespace Drv {
  ...
  void FPGADriverGTestBase ::
    assert_from_timeRTIOut_size(
        const char *const __ISF_callSiteFileName,
        const U32 __ISF_callSiteLineNumber,
        const U32 size
    ) const
  {
    ASSERT_EQ(size, this->fromPortHistory_timeRTIOut->size())
      << "\n"
      << "  File:     " << __ISF_callSiteFileName << "\n"
      << "  Line:     " << __ISF_callSiteLineNumber << "\n"
      << "  Value:    Size of history for from_timeRTIOut\n"
      << "  Expected: " << size << "\n"
      << "  Actual:   " << this->fromPortHistory_timeRTIOut->size() << "\n";
  }
